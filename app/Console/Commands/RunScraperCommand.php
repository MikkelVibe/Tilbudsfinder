...
#[Signature('scraper:run {grocer : The grocer scraper key, e.g. rema1000, netto, foetex, or bilka} {--limit= : Limit discovered products/offers for live smoke tests} {--no-delay : Disable scraper politeness delays for tests only}')]
